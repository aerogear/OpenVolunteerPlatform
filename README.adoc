...
* Volounteers distribute forms (Google Forms) in a community. The form can be scanned using a phone.
* Participants answer a few basic questions related to an individual's:
** Current situation - 
** Personal needs - 
** Medical neeeds-  

NOTE: The same leaflet can be used to gather posible volounteers. 
