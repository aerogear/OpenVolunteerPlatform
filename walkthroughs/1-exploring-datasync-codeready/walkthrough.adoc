...
. Put `https://github.com/aerogear/datasync-starter` into repository URL
...
. Execute `start app` command in the new terminal
. Client side application will be build and started
. Open Application URL in the new window
