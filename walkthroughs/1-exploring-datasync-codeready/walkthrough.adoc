...
. Edit the URL in your browser and append following path to the CodeReady hostname `/f?url=https://github.com/aerogear/datasync-starter/tree/walkthrough`
...
. In your project go to the `./model/task.graphql` file. 
This file contains a partial link:https://graphql.org/learn/schema/#object-types-and-fields[GraphQL Schema, window="_blank"]. Here you can define the data your application will deal with.
...
DataSync provides code generation capabilities that transform your model into a fully 
