...
var init_1 = require("../components/init");
exports.command = 'init <name>';
exports.desc = 'Create project from available templates';
...
function handler(_a) {
    var name = _a.name, templateName = _a.templateName, templateUrl = _a.templateUrl;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, init_1.init(name, templateName, templateUrl)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
